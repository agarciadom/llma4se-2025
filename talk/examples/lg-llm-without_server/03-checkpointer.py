...
if __name__ == "__main__":
    ...
    print("First interaction with thread ID {} and in-memory checkpointing".format(thread_id))
    ...
    print("\n---\nSecond interaction with thread ID {} and in-memory checkpointing".format(thread_id))
